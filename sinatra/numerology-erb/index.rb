...
#Create another route to display messages
get '/newpage/' do
...
#@message now an instance variable to use in index view
get '/:birthdate' do
  setup_index_view
	#birthdate = params[:birthdate]
	#birth_path_num = get_birth_path_num(birthdate)
	#@message = get_message(birth_path_num)
	#remove display message and tell Sinatra what view file to use to display message
  #"#{@message}"
 # erb :index
end
...
post '/' do
 ...
 # setup_index_view
  # "#{params}"
  #Grab parameters and save the birthdate
#  birthdate = params[:birthdate]
#  birth_path_num = get_birth_path_num(birthdate)
#  @message = get_message(birth_path_num)
#  erb :index
